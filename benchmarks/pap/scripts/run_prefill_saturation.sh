...
# It uses the production PAP Prefill static-MPS allocation (18 chunks / 72 SM)
...
PREFILL_CHUNKS="${PAP_PREFILL_MICROBENCH_CHUNKS:-18}"
EXPECTED_SMS="${PAP_PREFILL_MICROBENCH_EXPECTED_SMS:-72}"
