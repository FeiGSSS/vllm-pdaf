...
- dynamic off：
  `test/baseline/pap/results/runs/20260714_async_mps_ab_c4_dynamic_off`
- dynamic on：
  `test/baseline/pap/results/runs/20260714_async_mps_ab_c4_dynamic_on`
- static off：
  `test/baseline/pap/results/runs/20260714_async_mps_ab_c4_static_off`
- static on：
  `test/baseline/pap/results/runs/20260714_async_mps_ab_c4_static_on`
