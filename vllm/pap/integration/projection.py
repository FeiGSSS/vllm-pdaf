...
def _filter_mapping(
    ...
    return {
        key: value for key, value in mapping.items() if key in request_id_set
    }
...
def build_projection_forward_context(
    ...
    *,
    ...
    return {
        ...
        "pap_offload_exec_zmq_endpoint_by_request": _filter_mapping(
            store.offload_exec_zmq_endpoint_by_request, normalized_ids
        ),
